...
export default function Blogs() {
  ...
  return (
    <>
      <Helmet>
        <title>Farming Blogs & Tips - MandiFree</title>
        <meta
          name="description"
          content="Read expert blogs on agriculture pricing, organic farming, direct sales, and more. Improve your farming business with actionable tips."
        />
        <meta name="keywords" content="Farming, Agriculture, Blogs, Organic, Pricing, Tips" />
      </Helmet>
      ...
      <div className="bg-gradient-to-b from-green-50 via-white to-green-100 min-h-screen py-12 px-6 md:px-16">
        ...
        <div className="flex justify-center mb-10">
          <div className="relative w-full max-w-lg">
            ...
            />
            <FaSearch className="absolute right-4 top-3.5 text-green-500 text-lg" aria-hidden="true" />
          </div>
        </div>
            ...
            filteredBlogs.map((blog, index) => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-green-600 text-white px-3 py-1 rounded-full text-sm shadow-md">
                    {blog.category}
                  </span>
